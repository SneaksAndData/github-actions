...
4) ⚠️ If the input `public_package_index_token` is provided and `repo_url` is not provided, this action will push the package to a **public repository** (https://pypi.org)
